...
class lc_path_pub :
    def __init__(self):
        ...
        # 설명이랑 너무 다른데..?
        # Odometry, Object 데이터는 수신이 맞고
        # Gloabl Path와 local_path는 송신하는 것이 맞는 것 같은데.. 
        # 어디에 토익명을 '/lane_change_path'라고 넣는지 모르겠다; 일단, 지역경로에 활용한다고 했으니..
        ...
        # 읽어 온 경로 데이터를 변수에 넣으라고 주석이라도 달아줘야 좀.. 
