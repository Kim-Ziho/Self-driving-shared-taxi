...
def talker():
    ...
    ego_setting_msg.global_position_x = [ 141.0 ]
    ego_setting_msg.global_position_y = [ 1340.0 ]
    ego_setting_msg.global_position_z = [ 0.0 ]
    ...
    while not rospy.is_shutdown():
        ...
        # publisher로 ego_setting_msg을 publish하는 것 이겠지..
